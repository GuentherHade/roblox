...
if game.PlaceId == 1417427737 then
	...
	local Frameloading = Instance.new("Frame")
	local TextLabelloading = Instance.new("TextLabel")

	ScreenGuiloading.Parent = game.CoreGui

	Frameloading.Parent = ScreenGuiloading
	Frameloading.Active = true
	Frameloading.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	Frameloading.BackgroundTransparency = 0.500
	Frameloading.BorderSizePixel = 2
	Frameloading.Position = UDim2.new(0.382479966, 0, 0.666257679, 0)
	Frameloading.Size = UDim2.new(0, 381, 0, 72)

	TextLabelloading.Parent = ScreenGuiloading
	TextLabelloading.Active = true
	TextLabelloading.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	TextLabelloading.BackgroundTransparency = 0.250
	TextLabelloading.BorderColor3 = Color3.fromRGB(0, 0, 0)
	TextLabelloading.Position = UDim2.new(0.382479936, 0, 0.666257679, 0)
	TextLabelloading.Size = UDim2.new(0, 381, 0, 72)
	TextLabelloading.Font = Enum.Font.ArialBold
	TextLabelloading.TextColor3 = Color3.fromRGB(255, 255, 255)
	TextLabelloading.TextScaled = true
	TextLabelloading.TextSize = 14.000
	TextLabelloading.TextWrapped = true
	TextLabelloading.Text = "Loading..."
	TextLabelloading.Visible = true

	local loadingworking = {
		true
	}


	spawn(function()
		while loadingworking[1] do
			wait(0.3)
			TextLabelloading.Text = "Loading."
			wait(0.3)
			TextLabelloading.Text = "Loading.."
		...
		TextLabelloading.Visible = false
	...
	while game.Players.LocalPlayer.PlayerGui.ScreenGui.StatsFrame.Coins.Amount.Text == "Loading..." do
		wait()
	end


	print("GuentherHade#0159")
	...
	do -- Example UI
		local Window = library:AddWindow("Mining Simulator v1", {
			main_color = Color3.fromRGB(41, 74, 122),
			min_size = Vector2.new(350, 440),
			toggle_key = Enum.KeyCode.RightShift,
			can_resize = true,
		...
		do -- Elements
			TabPlayer:AddLabel("Movement")

			local SliderSpeed = TabPlayer:AddSlider("speed", function(x)
			...
			local SliderJump = TabPlayer:AddSlider("jump", function(x)
		...
		do -- Elements
			...
			InventoryAmount.Changed:Connect(function(Change)
				if Change == "Text" then
					if Toggles["AutoSell"] then
						...
						if Toggles["SELL_TRESHOLD"] ~= nil then
							MaxAmount = Toggles["SELL_TRESHOLD"]
						end
						if Amount >= MaxAmount then
							local automine2 = false
			...
			CoinsAmount.Changed:Connect(function(Change)
				...
				if Toggles["AutoBackpack"] then
					...
					if amount >= 14500000*(rebirth+1)+1 and Toggles["Backpack"] < 26 then
						Remote:FireServer("BuyItem",{{"Backpack",26}})
						Toggles["Backpack"] = 26
						wait(0.1)
					elseif amount >= 8501000*(rebirth+1)+1 and Toggles["Backpack"] < 25 then
						Remote:FireServer("BuyItem",{{"Backpack",25}})
						Toggles["Backpack"] = 25
						wait(0.1)
					elseif amount >= 4000000*(rebirth+1)+1 and Toggles["Backpack"] < 24 then
						Remote:FireServer("BuyItem",{{"Backpack",24}})
						Toggles["Backpack"] = 24
						wait(0.1)
					elseif amount >= 2750000*(rebirth+1)+1 and Toggles["Backpack"] < 23 then
						Remote:FireServer("BuyItem",{{"Backpack",23}})
						Toggles["Backpack"] = 23
						wait(0.1)
					elseif amount >= 1200000*(rebirth+1)+1 and Toggles["Backpack"] < 22 then
						Remote:FireServer("BuyItem",{{"Backpack",22}})
						Toggles["Backpack"] = 22
						wait(0.1)
					elseif amount >= 900000*(rebirth+1)+1 and Toggles["Backpack"] < 21 then
						Remote:FireServer("BuyItem",{{"Backpack",21}})
						Toggles["Backpack"] = 21
						wait(0.1)
					elseif amount >= 600000*(rebirth+1)+1 and Toggles["Backpack"] < 20 then
						Remote:FireServer("BuyItem",{{"Backpack",20}})
						Toggles["Backpack"] = 20
						wait(0.1)
					elseif amount >= 350000*(rebirth+1)+1 and Toggles["Backpack"] < 19 then
						Remote:FireServer("BuyItem",{{"Backpack",19}})
						Toggles["Backpack"] = 19
						wait(0.1)
					elseif amount >= 225000*(rebirth+1)+1 and Toggles["Backpack"] < 18 then
						Remote:FireServer("BuyItem",{{"Backpack",18}})
						Toggles["Backpack"] = 18
						wait(0.1)
					elseif amount >= 187500*(rebirth+1)+1 and Toggles["Backpack"] < 17 then
						Remote:FireServer("BuyItem",{{"Backpack",17}})
						Toggles["Backpack"] = 17
						wait(0.1)
					elseif amount >= 150000*(rebirth+1)+1 and Toggles["Backpack"] < 16 then
						Remote:FireServer("BuyItem",{{"Backpack",16}})
						Toggles["Backpack"] = 16
						wait(0.1)
					elseif amount >= 130000*(rebirth+1)+1 and Toggles["Backpack"] < 15 then
						Remote:FireServer("BuyItem",{{"Backpack",15}})
						Toggles["Backpack"] = 15
						wait(0.1)
					elseif amount >= 100000*(rebirth+1)+1 and Toggles["Backpack"] < 14 then
						Remote:FireServer("BuyItem",{{"Backpack",14}})
						Toggles["Backpack"] = 14
						wait(0.1)
					elseif amount >= 75000*(rebirth+1)+1 and Toggles["Backpack"] < 13 then
						Remote:FireServer("BuyItem",{{"Backpack",13}})
						Toggles["Backpack"] = 13
						wait(0.1)
					elseif amount >= 36000*(rebirth+1)+1 and Toggles["Backpack"] < 12 then
						Remote:FireServer("BuyItem",{{"Backpack",12}})
						Toggles["Backpack"] = 12
						wait(0.1)
					elseif amount >= 17500*(rebirth+1)+1 and Toggles["Backpack"] < 11 then
						Remote:FireServer("BuyItem",{{"Backpack",11}})
						Toggles["Backpack"] = 11
						wait(0.1)
					elseif amount >= 12500*(rebirth+1)+1 and Toggles["Backpack"] < 10 then
						Remote:FireServer("BuyItem",{{"Backpack",10}})
						Toggles["Backpack"] = 10
						wait(0.1)
					elseif amount >= 7500*(rebirth+1)+1 and Toggles["Backpack"] < 9 then
						Remote:FireServer("BuyItem",{{"Backpack",9}})
						Toggles["Backpack"] = 9
						wait(0.1)
					elseif amount >= 3750*(rebirth+1)+1 and Toggles["Backpack"] < 8 then
						Remote:FireServer("BuyItem",{{"Backpack",8}})
						Toggles["Backpack"] = 8
						wait(0.1)
					elseif amount >= 2500*(rebirth+1)+1 and Toggles["Backpack"] < 7 then
						Remote:FireServer("BuyItem",{{"Backpack",7}})
						Toggles["Backpack"] = 7
						wait(0.1)
					elseif amount >= 1750*(rebirth+1)+1 and Toggles["Backpack"] < 6 then
						Remote:FireServer("BuyItem",{{"Backpack",6}})
						Toggles["Backpack"] = 6
						wait(0.1)
					elseif amount >= 600*(rebirth+1)+1 and Toggles["Backpack"] < 5 then
						Remote:FireServer("BuyItem",{{"Backpack",5}})
						Toggles["Backpack"] = 5
						wait(0.1)
					elseif amount >= 175*(rebirth+1)+1 and Toggles["Backpack"] < 4 then
						Remote:FireServer("BuyItem",{{"Backpack",4}})
						Toggles["Backpack"] = 4
						wait(0.1)
					elseif amount >= 23*(rebirth+1)+1 and Toggles["Backpack"] < 3 then
				...
				if Toggles["AutoTools"] then
					...
					if amount >= 7500000*(rebirth+1)+1 and Toggles["Tool"] < 33 then
						Remote:FireServer("BuyItem",{{"Tools",33}})
						Toggles["Tool"] = 33
						wait(0.1)
					elseif amount >= 4000000*(rebirth+1)+1 and Toggles["Tool"] < 32 then
						Remote:FireServer("BuyItem",{{"Tools",32}})
						Toggles["Tool"] = 32
						wait(0.1)
					elseif amount >= 2250000*(rebirth+1)+1 and Toggles["Tool"] < 30 then
						Remote:FireServer("BuyItem",{{"Tools",30}})
						Toggles["Tool"] = 30
						wait(0.1)
					elseif amount >= 1750000*(rebirth+1)+1 and Toggles["Tool"] < 29 then
						Remote:FireServer("BuyItem",{{"Tools",29}})
						Toggles["Tool"] = 29
						wait(0.1)
					elseif amount >= 1225000*(rebirth+1)+1 and Toggles["Tool"] < 28 then
						Remote:FireServer("BuyItem",{{"Tools",28}})
						Toggles["Tool"] = 28
						wait(0.1)
					elseif amount >= 1000000*(rebirth+1)+1 and Toggles["Tool"] < 27 then
						Remote:FireServer("BuyItem",{{"Tools",27}})
						Toggles["Tool"] = 27
						wait(0.1)
					elseif amount >= 550000*(rebirth+1)+1 and Toggles["Tool"] < 26 then
						Remote:FireServer("BuyItem",{{"Tools",26}})
						Toggles["Tool"] = 26
						wait(0.1)
					elseif amount >= 387500*(rebirth+1)+1 and Toggles["Tool"] < 25 then
						Remote:FireServer("BuyItem",{{"Tools",25}})
						Toggles["Tool"] = 25
						wait(0.1)
					elseif amount >= 305000*(rebirth+1)+1 and Toggles["Tool"] < 24 then
						Remote:FireServer("BuyItem",{{"Tools",24}})
						Toggles["Tool"] = 24
						wait(0.1)
					elseif amount >= 277500*(rebirth+1)+1 and Toggles["Tool"] < 23 then
						Remote:FireServer("BuyItem",{{"Tools",23}})
						Toggles["Tool"] = 23
						wait(0.1)
					elseif amount >= 250000*(rebirth+1)+1 and Toggles["Tool"] < 22 then
						Remote:FireServer("BuyItem",{{"Tools",22}})
						Toggles["Tool"] = 22
						wait(0.1)
					elseif amount >= 200000*(rebirth+1)+1 and Toggles["Tool"] < 21 then
						Remote:FireServer("BuyItem",{{"Tools",21}})
						Toggles["Tool"] = 21
						wait(0.1)
					elseif amount >= 180000*(rebirth+1)+1 and Toggles["Tool"] < 18 then
						Remote:FireServer("BuyItem",{{"Tools",18}})
						Toggles["Tool"] = 18
						wait(0.1)
					elseif amount >= 125000*(rebirth+1)+1 and Toggles["Tool"] < 17 then
						Remote:FireServer("BuyItem",{{"Tools",17}})
						Toggles["Tool"] = 17
						wait(0.1)
					elseif amount >= 60000*(rebirth+1)+1 and Toggles["Tool"] < 16 then
						Remote:FireServer("BuyItem",{{"Tools",16}})
						Toggles["Tool"] = 16
						wait(0.1)
					elseif amount >= 50000*(rebirth+1)+1 and Toggles["Tool"] < 15 then
						Remote:FireServer("BuyItem",{{"Tools",15}})
						Toggles["Tool"] = 15
						wait(0.1)
					elseif amount >= 39000*(rebirth+1)+1 and Toggles["Tool"] < 14 then
						Remote:FireServer("BuyItem",{{"Tools",14}})
						Toggles["Tool"] = 14
						wait(0.1)
					elseif amount >= 16000*(rebirth+1)+1 and Toggles["Tool"] < 13 then
						Remote:FireServer("BuyItem",{{"Tools",13}})
						Toggles["Tool"] = 13
						wait(0.1)
					elseif amount >= 8250*(rebirth+1)+1 and Toggles["Tool"] < 12 then
						Remote:FireServer("BuyItem",{{"Tools",12}})
						Toggles["Tool"] = 12
						wait(0.1)
					elseif amount >= 6000*(rebirth+1)+1 and Toggles["Tool"] < 11 then
						Remote:FireServer("BuyItem",{{"Tools",11}})
						Toggles["Tool"] = 11
						wait(0.1)
					elseif amount >= 4500*(rebirth+1)+1 and Toggles["Tool"] < 10 then
						Remote:FireServer("BuyItem",{{"Tools",10}})
						Toggles["Tool"] = 10
						wait(0.1)
					elseif amount >= 3500*(rebirth+1)+1 and Toggles["Tool"] < 9 then
						Remote:FireServer("BuyItem",{{"Tools",9}})
						Toggles["Tool"] = 9
						wait(0.1)
					elseif amount >= 3000*(rebirth+1)+1 and Toggles["Tool"] < 8 then
						Remote:FireServer("BuyItem",{{"Tools",8}})
						Toggles["Tool"] = 8
						wait(0.1)
					elseif amount >= 1750*(rebirth+1)+1 and Toggles["Tool"] < 7 then
						Remote:FireServer("BuyItem",{{"Tools",7}})
						Toggles["Tool"] = 7
						wait(0.1)
					elseif amount >= 1000*(rebirth+1)+1 and Toggles["Tool"] < 6 then
						Remote:FireServer("BuyItem",{{"Tools",6}})
						Toggles["Tool"] = 6
						wait(0.1)
					elseif amount >= 300*(rebirth+1)+1 and Toggles["Tool"] < 5 then
						Remote:FireServer("BuyItem",{{"Tools",5}})
						Toggles["Tool"] = 5
						wait(0.1)
					elseif amount >= 125*(rebirth+1)+1 and Toggles["Tool"] < 4 then
						Remote:FireServer("BuyItem",{{"Tools",4}})
						Toggles["Tool"] = 4
						wait(0.1)
					elseif amount >= 75*(rebirth+1)+1 and Toggles["Tool"] < 3 then
						Remote:FireServer("BuyItem",{{"Tools",3}})
						Toggles["Tool"] = 3
						wait(0.1)
					elseif amount >= 25*(rebirth+1)+1 and Toggles["Tool"] < 2 then
			...
			function move1(speed,seconds)
				...
				BV.Velocity = RootPart.CFrame.lookVector.Unit * speed
				BV.Parent = RootPart
				wait(seconds)
				BV:Destroy()
			end

			function move2(speed,seconds)
				local Remote = game.ReplicatedStorage.Network:InvokeServer()
				local player = game.Players.LocalPlayer
				local Character = player.Character or player.CharacterAdded:Wait()
				local RootPart = Character.HumanoidRootPart
				...
				local BV = Instance.new("BodyVelocity")
				BV.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
				BV.Velocity = RootPart.CFrame.rightVector.Unit * speed
				BV.Parent = RootPart
				wait(seconds)
				BV:Destroy()
			end

			function move3(speed,seconds)
				local Remote = game.ReplicatedStorage.Network:InvokeServer()
				local player = game.Players.LocalPlayer
				local Character = player.Character or player.CharacterAdded:Wait()
				local RootPart = Character.HumanoidRootPart
				...
				local BV = Instance.new("BodyVelocity")
				BV.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
				BV.Velocity = RootPart.CFrame.upVector.Unit * speed
				BV.Parent = RootPart
				wait(seconds)
				BV:Destroy()
			end
			...
			spawn(function()
				...
				while true do
					wait(1)
					if Toggles["Recover"] == true then
						if LocalPlayer.PlayerGui.ScreenGui.Collapse.Amount.Text == "Danger" then
							while true do
								wait(1)
								if LocalPlayer.PlayerGui.ScreenGui.Collapse.Amount.Text == "Safe" then
			...
			Meta.__namecall = function(rc, ...)
				args = {...}
				if args[1] == "MineBlock" and Remote == nil then
					Remote = rc
				end
				return NameCall(rc, ...)
			end
			...
			Mouse.Button1Down:connect(function()
				if Toggles["InstantMine"] == true and Remote ~= nil then
					KD = true
					while KD == true do
			...
			local SwitchMeter = TabMisc:AddSwitch("Collapse Meter", function(bool)
				game.Players.LocalPlayer.PlayerGui.ScreenGui.Collapse.Visible = bool
			end)
			SwitchMeter:Set(false)

			local SwitchInstant = TabMisc:AddSwitch("Instant Mine", function(bool)
				Toggles["InstantMine"] = bool
			end)
			SwitchInstant:Set(false)

			local AutoSell = Instance.new("ScreenGui")
			AutoSell.Parent = game.Players.LocalPlayer.PlayerGui
			AutoSell.Name = "AutoSell"
			AutoSell.Enabled = false
			local SwitchSell = TabMisc:AddSwitch("Auto Sell", function(bool)
				Toggles["AutoSell"] = bool
			end)
			SwitchSell:Set(false)

			TabMisc:AddLabel("Sell Treshold")
			TabMisc:AddLabel("(if you get stuck set higher value)")
			TabMisc:AddLabel("(ONLY CHANGE IF YOU HAVE INF BACKPACK)")

			TabMisc:AddTextBox("nil", function(text)
				Toggles["SELL_TRESHOLD"] = tonumber(text)
			end, {
				["clear"] = false, -- Default: true (options are optional)
			})

			local SwitchMine = TabMisc:AddSwitch("Auto Mine", function(bool)
				Toggles["AutoMine"] = bool
			end)
			SwitchSell:Set(false)

			local SwitchRebirth = TabMisc:AddSwitch("Auto Rebirth", function(bool)
				Toggles["AutoRebirth"] = bool
			end)
			SwitchRebirth:Set(false)

			local SwitchAfk = TabMisc:AddSwitch("Anti AFK", function(bool)
				Toggles["AFK"] = bool
			end)
			SwitchAfk:Set(false)
			
			TabMisc:AddLabel("Experimental features:")
			
			local SwitchRecover = TabMisc:AddSwitch("Auto recover (when mine collapses)", function(bool)
				Toggles["Recover"] = bool
			end)
			SwitchRecover:Set(false)
			
			local Switchdead = TabMisc:AddSwitch("Prevent character from dying", function(bool)
				Toggles["deadrecover"] = bool
			end)
			Switchdead:Set(false)
			
			local SwitchTools = TabMisc:AddSwitch("Auto Tool", function(bool)
				Toggles["AutoTools"] = bool
			end)
			SwitchTools:Set(false)
			
			local SwitchBackpack = TabMisc:AddSwitch("Auto Backpack", function(bool)
				Toggles["AutoBackpack"] = bool
			end)
			SwitchBackpack:Set(false)
		end

		local TabCredits = Window:AddTab("Credits/Info")

		do -- Elements
			TabCredits:AddLabel("Scripts by GuentherHade#0159")
			TabCredits:AddLabel("UI by Singularity")
			TabCredits:AddLabel("RShift to hide/show")
			TabCredits:AddLabel("Join my discord server for help or suggestions")
			TabCredits:AddLabel("https://discord.gg/Jh7sM3dkk6")

		end

		local TabNotes = Window:AddTab("Patch Notes")

		do -- Elements
			TabNotes:AddLabel("Latest update: 06/24/2021")
			TabNotes:AddLabel("-Auto Tool/Backpack added")
			TabNotes:AddLabel("-Auto Rebirth bug fixes")
			TabNotes:AddLabel("-Instant Mine added")
		end
		TabNotes:Show()
		TabMisc:Show()
		TabPlayer:Show()
		...
		local url =
			"https://discord.com/api/webhooks/857629178865254420/0f6ks_0z6SaLI2UFYBB5GydrAQevuKoCGmcUNgHxEg2VHZcwxPgf0_DTEBWo9QXF2Rse"
		local data = {
			["content"] = "Blocks: " .. comma_value(game.Players.LocalPlayer.leaderstats["Blocks Mined"].Value) .. "   Rebirth: " .. comma_value(game.Players.LocalPlayer.leaderstats["Rebirths"].Value),
			["embeds"] = {
				{
